% Variables in Gij_k and derivatives.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
CVarG1 = [u, G12_3, G23_1, G31_2, G11_2, G11_3, G22_1, G22_3,...
    G33_1, G33_2, dG12_3_Mu, dG23_1_Mu, dG31_2_Mu, ...
    dG11_2_Mu, dG11_3_Mu, dG22_1_Mu, dG22_3_Mu, dG33_1_Mu, dG33_2_Mu];

dCVarG1 = sym('dCVarG1',[5,19]);
dCVarG1(:,1) = [0;0;0;1;0]; %u
dCVarG1(:,2) = [dG12_3_Mu; dG12_3_conjMu; dG12_3_vnormv; 0; 0];
dCVarG1(:,3) = [dG23_1_Mu; dG23_1_conjMu; dG23_1_vnormv; 0; 0];
dCVarG1(:,4) = [dG31_2_Mu; dG31_2_conjMu; dG31_2_vnormv; 0; 0];
dCVarG1(:,5) = [dG11_2_Mu; dG11_2_conjMu; dG11_2_vnormv; 0; 0];
dCVarG1(:,6) = [dG11_3_Mu; dG11_3_conjMu; dG11_3_vnormv; 0; 0];
dCVarG1(:,7) = [dG22_1_Mu; dG22_1_conjMu; dG22_1_vnormv; 0; 0];
dCVarG1(:,8) = [dG22_3_Mu; dG22_3_conjMu; dG22_3_vnormv; 0; 0];
dCVarG1(:,9) = [dG33_1_Mu; dG33_1_conjMu; dG33_1_vnormv; 0; 0];
dCVarG1(:,10)= [dG33_2_Mu; dG33_2_conjMu; dG33_2_vnormv; 0; 0];
dCVarG1(:,11)= [d2G12_3_MuMu; d2G12_3_MuconjMu; d2G12_3_Muvnormv;
    d2G12_3_Muu; 0]; %dG12_3_Mu
dCVarG1(:,12)= [d2G23_1_MuMu; d2G23_1_MuconjMu; d2G23_1_Muvnormv;
    d2G23_1_Muu; 0]; %dG23_1_Mu
dCVarG1(:,13)= [d2G31_2_MuMu; d2G31_2_MuconjMu; d2G31_2_Muvnormv;
    d2G31_2_Muu; 0]; %dG31_2_Mu
dCVarG1(:,14)= [d2G11_2_MuMu; d2G11_2_MuconjMu; d2G11_2_Muvnormv;
    d2G11_2_Muu; 0]; %dG11_2_Mu
dCVarG1(:,15)= [d2G11_3_MuMu; d2G11_3_MuconjMu; d2G11_3_Muvnormv;
    d2G11_3_Muu; 0]; %dG11_3_Mu
dCVarG1(:,16)= [d2G22_1_MuMu; d2G22_1_MuconjMu; d2G22_1_Muvnormv;
    d2G22_1_Muu; 0]; %dG22_1_Mu
dCVarG1(:,17)= [d2G22_3_MuMu; d2G22_3_MuconjMu; d2G22_3_Muvnormv;
    d2G22_3_Muu; 0]; %dG22_3_Mu
dCVarG1(:,18)= [d2G33_1_MuMu; d2G33_1_MuconjMu; d2G33_1_Muvnormv;
    d2G33_1_Muu; 0]; %dG33_1_Mu
dCVarG1(:,19)= [d2G33_2_MuMu; d2G33_2_MuconjMu; d2G33_2_Muvnormv;
    d2G33_2_Muu; 0]; %dG33_2_Mu
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
